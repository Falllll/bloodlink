...
final class DeferralReasonSeeder extends Seeder
{
    ...
    private function rows(): array
    {
        return [
            ...
            [
                'jurisdiction' => self::JURISDICTION,
                'code' => 'LOW_HAEMOGLOBIN',
                'type' => DeferralType::TEMPORARY->value,
                'default_duration_value' => null,
                'default_duration_unit' => null,
                'label' => 'Hemoglobin di bawah ambang saat skrining',
                'anchor_note' => 'Durasi kosong: Turunan dari Rujukan Pedoman Medis §3.6, bukan Dikutip. WHO memberi ambang Hb (§3.3), bukan lama penundaannya.',
                'source_reference' => 'WHO 2012 Blood Donor Selection §3.3 (ambang Hb); Rujukan Pedoman Medis §3.6 (Turunan, durasi penundaan tidak diberikan WHO).',
                'is_active' => true,
            ],
            [
                'jurisdiction' => self::JURISDICTION,
                ...
                'default_duration_value' => null,
                'default_duration_unit' => null,
                'label' => 'Tanda vital di luar rentang saat skrining',
                'anchor_note' => 'Durasi kosong: Turunan dari Rujukan Pedoman Medis §3.6, bukan Dikutip. WHO memberi rentang nadi/tensi/suhu (§3.4), bukan lama penundaannya.',
                'source_reference' => 'WHO 2012 Blood Donor Selection §3.4 (rentang tanda vital); Rujukan Pedoman Medis §3.6 (Turunan, durasi penundaan tidak diberikan WHO).',
                'is_active' => true,
            ],
            [
                'jurisdiction' => self::JURISDICTION,
                'code' => 'UNDERWEIGHT_FOR_VOLUME',
                'type' => DeferralType::TEMPORARY->value,
                'default_duration_value' => null,
                'default_duration_unit' => null,
                'label' => 'Berat badan di bawah ambang volume rencana saat skrining',
                'anchor_note' => 'Durasi kosong: Turunan dari Rujukan Pedoman Medis §3.6, bukan Dikutip. WHO memberi ambang berat per volume (§3.2), bukan lama penundaannya.',
                'source_reference' => 'WHO 2012 Blood Donor Selection §3.2 (ambang berat per volume); Rujukan Pedoman Medis §3.6 (Turunan, durasi penundaan tidak diberikan WHO).',
                'is_active' => true,
            ],
        ];
    }
